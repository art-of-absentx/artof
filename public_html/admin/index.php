...
require __DIR__ . '/../../advanced/backend/config/bootstrap.php';

$config = yii\helpers\ArrayHelper::merge(
    require __DIR__ . '/../../advanced/common/config/main.php',
    require __DIR__ . '/../../advanced/common/config/main-local.php',
    require __DIR__ . '/../../advanced/backend/config/main.php',
    require __DIR__ . '/../../advanced/backend/config/main-local.php'
);
